...
//     function load_data() {
//         const url = (process.env.REACT_APP_SERVER || "http://localhost:3000") + "/load_question_data";
//         fetch(url, {
//             method: 'POST',
//             headers: {
...
//         const url = (process.env.REACT_APP_SERVER || "http://localhost:3000") + "/save_question_data";
//         fetch(url, {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
...
//         const url = (process.env.REACT_APP_SERVER || "http://localhost:3000") + "/refresh";
//         fetch(url, {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
